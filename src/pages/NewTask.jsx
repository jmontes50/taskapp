...
export default function NewTask() {
  ...
  const notify = () => toast.success("Proyecto creado con éxito");
  ...
  const handleSubmit = async (e) => {
    try {
      e.preventDefault();
      console.log("Proyecto enviado:", project);
      await addDocument("tasks", project);
      notify();
      navigate("/tasks");
    } catch (error) {
      console.log(error);
  ...
  return (
    <>
      ...
      <div className={styles["form-container"]}>
        <h2 className={styles["form-title"]}>Crear Proyecto</h2>
